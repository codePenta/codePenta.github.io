...
| `yarn test`    | Führt die Tests unter `scripts/` aus (Node-Test-Runner) |
...
├── public/
│   ├── assets/                       # Farbpalette
│   ├── data/projects.json            # Von scripts/updateProjects.js generierte Projektdaten
│   └── CNAME                         # Custom-Domain-Konfiguration für GitHub Pages
├── scripts/
│   ├── updateProjects.js             # Ablauf: Repos holen, mappen, projects.json schreiben
│   └── lib/                          # github.js (API-Abruf), mapProject.js (Repo → Projekt) + Test
├── src/
